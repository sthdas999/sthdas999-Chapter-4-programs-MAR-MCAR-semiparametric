...
n1= 2 ## number of finite samples to approximate the weighted sum of chi-squares random variables ##
...
plot(gm, KS, xlim=c(0,10), ylim=c(0,1), type="l", pch=10, col="red", xlab=expression(gamma), ylab=expression("Semiparametric Powers (MAR & ILLS)"))
# Add a line
